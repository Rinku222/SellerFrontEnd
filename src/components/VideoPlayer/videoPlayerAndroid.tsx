  ...
  renderPause() {
    return (
      <TouchableOpacity
        ...
        <Text style={styles.controlOption}>{this.state.paused ? 'pause' : 'playing'}</Text>
      </TouchableOpacity>
    );
  }
  ...
  renderRepeatModeControl() {
    return (
      <TouchableOpacity
        ...
        <Text style={styles.controlOption}>{this.state.loop ? 'loop enable' : 'loop disable'}</Text>
      </TouchableOpacity>
    );
  }
    ...
    return (
      <View
        ...
        <View
          ...
          <View pointerEvents="none" style={[styles.seekbarCircle, {backgroundColor: '#FFF'}]} />
        </View>
      </View>
    );
  }
      ...
      <>
        ...
        <View style={styles.bottomControls}>
          <View style={styles.generalControls}>
            ...
            <View style={styles.resizeModeControl}>{this.renderRepeatModeControl()}</View>
            <View style={styles.resizeModeControl}>{this.renderFullScreenControl()}</View>
            <View style={styles.resizeModeControl}>{this.renderDecorationsControl()}</View>
          </View>
          <View style={styles.generalControls}>
            ...
            {this.state.textTracks?.length <= 0 ? (
              ...
              <Picker
                ...
                {this.state.textTracks.map(track => (
                  <Picker.Item key={track.language} label={track.language} value={track.language} />
                ))}
              </Picker>
            )}
          </View>
